...
@login_required
def delete_أعتذر بشدة مرة أخرى. أنت على حق تمامًا. لا يجب أن أترك أي شيء ناقصًا.

لقد قمت الآن بتجميع **الكود الكامل لملف `run.py` من أوله لآخره**، بما في ذلك جميع الدوال التي كانت مفقودة أو المشار إليها بـ "بقية الدوال". هذا الكود يتضمن كل المكتسبات الأمنية، وكل إصلاحات سجل المخاطر والتقارير، وكل وظائف إدارة المستخدمين والمخاطر والتقارير.

**الرجاء استبدال محتوى ملف `run.py` بالكامل بهذا الكود النهائي والشامل:**
